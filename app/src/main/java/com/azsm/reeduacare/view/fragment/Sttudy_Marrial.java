 ...
 */
public class Sttudy_Marrial extends Fragment {
  ...
  private void activequestionlist() {
      ...
      String url = "https://swasthyaayur.com/adwogindia.com/raushanedu/public/api/study-material-detail?subject_id="+ MyCource_Tab_Layout.id;
                  ...
                  public void onResponse(String response) {
                      ...
                      try {
                         ...
                         // Toast.makeText(CourseProvide.this, "stats=>"+status, Toast.LENGTH_SHORT).show();
                          JSONArray whishlistarray=object.getJSONArray("studydetail");
                          if (status.equals("200")) {
                              ...
                              for (int i=0;i<whishlistarray.length();i++)
                              {
                                  ...
                                  String course_title=jsonObject.getString("topic");
                                  String course_image=jsonObject.getString("study_data");
                                  atempttLists.add(new AtempttList(course_title,"pdf","https://swasthyaayur.com/adwogindia.com/raushanedu/public/"+course_image,courseid));
                                  LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
                                  recyclerView.setLayoutManager(layoutManager);
                                  layoutManager.setOrientation(RecyclerView.VERTICAL);
