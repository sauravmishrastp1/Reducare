 ...
 */
public class Viedos_fragment extends Fragment {
                  ...
                  public void onResponse(String response) {
                      ...
                      try {
                         ...
                         // Toast.makeText(CourseProvide.this, "stats=>"+status, Toast.LENGTH_SHORT).show();
                          JSONArray whishlistarray=object.getJSONArray("videos");
                          if (status.equals("200")) {
                              ...
                              for (int i=0;i<whishlistarray.length();i++)
                              {
                                  ...
                                  String course_title=jsonObject.getString("videos_title");
                                  String course_image=jsonObject.getString("videos_file");
                                  atempttLists.add(new AtempttList(course_title,"v","https://swasthyaayur.com/adwogindia.com/raushanedu/public/"+course_image,courseid));
                                  LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
                                  recyclerView.setLayoutManager(layoutManager);
                                  layoutManager.setOrientation(RecyclerView.VERTICAL);
