...
public class Active_Fragment extends Fragment {
  ...
  private void activequestionlist() {
      ...
      String url = "https://swasthyaayur.com/adwogindia.com/raushanedu/public/api/test-series-syllebus?test_series_id="+TestSeriessQuestionActivity.idt;
                  ...
                  public void onResponse(String response) {
                      ...
                      try {
                         ...
                         // Toast.makeText(CourseProvide.this, "stats=>"+status, Toast.LENGTH_SHORT).show();
                          JSONArray whishlistarray=object.getJSONArray("testseriessyllebus ");
