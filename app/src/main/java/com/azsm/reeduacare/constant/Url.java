...
public class Url {
    ...
    public static String BASEURL="https://swasthyaayur.com/adwogindia.com/raushanedu/public/api/";
    ...
    public static String GET_SEARCH_KEYWORD=BASEURL+"search";
    ...
    public static String SOCIAL_LOGIN=BASEURL+"socialLogin";
    ...
    public static String VIEW_CATEGORY = BASEURL+"type-to-category";
    public static String QUESTION_LIST = BASEURL+"";
